...
public class TabActionbarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pActionbar.addButton(new PActionbarButton(null, getResources().getDrawable(R.drawable.ic_search), v -> Toast.makeText(TabActionbarActivity.this,"Toast2 Button",Toast.LENGTH_SHORT).show()));
